...
class Insight(CachedModel):
    ...
    TYPED_LEADERBOARD_MOST_QUALIFYING_EVENT_WINS = 29
    ...
    INSIGHT_NAMES = {
        ...
        TYPED_LEADERBOARD_MOST_QUALIFYING_EVENT_WINS: "typed_leaderboard_most_qualifying_event_wins",
    ...
    TYPED_LEADERBOARD_AWARD_INSIGHTS = {
        ...
        TYPED_LEADERBOARD_MOST_QUALIFYING_EVENT_WINS,
    }
    ...
    TYPED_LEADERBOARD_KEY_TYPES: Dict[int, LeaderboardKeyType] = {
        ...
        TYPED_LEADERBOARD_MOST_QUALIFYING_EVENT_WINS: "team",
    }
