...
from typing import Any, DefaultDict, Dict, List, NamedTuple, Set, Tuple, TypedDict
...
class NotableEntry(TypedDict):
    ...
    # in an individual year, this should probably always be len 0
        ...
        for award_future in award_futures:
            ...
            if (
                ...
                for tk in award.team_list:
                    team_context_map[tk.id()] = [award.event.id()]
