...
class Insight(CachedModel):
    ...
    TYPED_LEADERBOARD_MOST_REGIONAL_DISTRICT_EVENT_WINS = 29
    ...
    INSIGHT_NAMES = {
        ...
        TYPED_LEADERBOARD_MOST_REGIONAL_DISTRICT_EVENT_WINS: "typed_leaderboard_most_regional_district_event_wins",
    ...
    TYPED_LEADERBOARD_AWARD_INSIGHTS = {
        ...
        TYPED_LEADERBOARD_MOST_REGIONAL_DISTRICT_EVENT_WINS,
    }
    ...
    TYPED_LEADERBOARD_KEY_TYPES: Dict[int, LeaderboardKeyType] = {
        ...
        TYPED_LEADERBOARD_MOST_REGIONAL_DISTRICT_EVENT_WINS: "team",
    }
